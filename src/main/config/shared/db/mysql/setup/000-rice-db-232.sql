...
--
-- Host: localhost    Database: RICE_251
-- ------------------------------------------------------
...
--
-- Table structure for table `KRTST_TEST_COLL_TWO_T`
--

DROP TABLE IF EXISTS `KRTST_TEST_COLL_TWO_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_TEST_COLL_TWO_T` (
  `PK_PROP` varchar(10) COLLATE utf8_bin NOT NULL DEFAULT '',
  `PK_COLL_KEY_PROP` varchar(10) COLLATE utf8_bin NOT NULL DEFAULT '',
  `STR_PROP` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`PK_PROP`,`PK_COLL_KEY_PROP`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `KRTST_TEST_COLL_TWO_T`
--

LOCK TABLES `KRTST_TEST_COLL_TWO_T` WRITE;
/*!40000 ALTER TABLE `KRTST_TEST_COLL_TWO_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_TEST_COLL_TWO_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_TYP_CHILD_T`
--

DROP TABLE IF EXISTS `KRTST_TYP_CHILD_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_TYP_CHILD_T` (
  `CHAR_PROP` char(1) COLLATE utf8_bin DEFAULT NULL,
  `BOOL_PROP` varchar(1) COLLATE utf8_bin DEFAULT NULL,
  `SHORT_PROP` decimal(5,0) DEFAULT NULL,
  `INT_PROP` decimal(10,0) DEFAULT NULL,
  `LONG_PROP` decimal(20,0) DEFAULT NULL,
  `FLOAT_PROP` decimal(10,2) DEFAULT NULL,
  `DOUBLE_PROP` decimal(20,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `KRTST_TYP_CHILD_T`
--

LOCK TABLES `KRTST_TYP_CHILD_T` WRITE;
/*!40000 ALTER TABLE `KRTST_TYP_CHILD_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_TYP_CHILD_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_COLL_CHLD_T`
--

DROP TABLE IF EXISTS `KRTST_COLL_CHLD_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_COLL_CHLD_T` (
  `PK_PROP` varchar(40) COLLATE utf8_bin NOT NULL,
  `PRNT_KEY` varchar(40) COLLATE utf8_bin NOT NULL,
  `CHAR_PROP` char(1) COLLATE utf8_bin DEFAULT NULL,
  `BOOL_PROP` varchar(1) COLLATE utf8_bin DEFAULT NULL,
  `SHORT_PROP` decimal(5,0) DEFAULT NULL,
  `INT_PROP` decimal(10,0) DEFAULT NULL,
...
--
-- Dumping data for table `KRTST_COLL_CHLD_T`
--

LOCK TABLES `KRTST_COLL_CHLD_T` WRITE;
/*!40000 ALTER TABLE `KRTST_COLL_CHLD_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_COLL_CHLD_T` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `KRTST_TEST_DISABLE_VER_T`
--

DROP TABLE IF EXISTS `KRTST_TEST_DISABLE_VER_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_TEST_DISABLE_VER_T` (
  `ID` varchar(10) COLLATE utf8_bin NOT NULL DEFAULT '',
  `OBJ_ID` varchar(36) COLLATE utf8_bin NOT NULL,
  `STR_PROP` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  `VER_NBR` decimal(8,0) NOT NULL DEFAULT '1',
  PRIMARY KEY (`ID`)
...
--
-- Dumping data for table `KRTST_TEST_DISABLE_VER_T`
--

LOCK TABLES `KRTST_TEST_DISABLE_VER_T` WRITE;
/*!40000 ALTER TABLE `KRTST_TEST_DISABLE_VER_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_TEST_DISABLE_VER_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_CONF_PRESENTER_S`
--

DROP TABLE IF EXISTS `KRTST_CONF_PRESENTER_S`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `KRTST_CONF_PRESENTER_S`
--

LOCK TABLES `KRTST_CONF_PRESENTER_S` WRITE;
/*!40000 ALTER TABLE `KRTST_CONF_PRESENTER_S` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_CONF_PRESENTER_S` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_CONF_PRESENTER_T`
--

DROP TABLE IF EXISTS `KRTST_CONF_PRESENTER_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_CONF_PRESENTER_T` (
  `ID` varchar(10) COLLATE utf8_bin NOT NULL,
  `NM` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  `INST_NM` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `KRTST_CONF_PRESENTER_T`
--

LOCK TABLES `KRTST_CONF_PRESENTER_T` WRITE;
/*!40000 ALTER TABLE `KRTST_CONF_PRESENTER_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_CONF_PRESENTER_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_CONF_LBL_EXT_T`
--

DROP TABLE IF EXISTS `KRTST_CONF_LBL_EXT_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_CONF_LBL_EXT_T` (
  `NM` varchar(40) COLLATE utf8_bin NOT NULL,
  `EXTRA` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`NM`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `KRTST_CONF_LBL_EXT_T`
--

LOCK TABLES `KRTST_CONF_LBL_EXT_T` WRITE;
/*!40000 ALTER TABLE `KRTST_CONF_LBL_EXT_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_CONF_LBL_EXT_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `TRVL_DEST_T`
--
...
CREATE TABLE `TRVL_DEST_T` (
  `TRVL_DEST_ID` varchar(40) COLLATE utf8_bin NOT NULL,
  `OBJ_ID` varchar(36) COLLATE utf8_bin NOT NULL,
  `VER_NBR` decimal(8,0) NOT NULL DEFAULT '1',
  `DEST_NM` varchar(40) COLLATE utf8_bin NOT NULL,
  `POSTAL_CNTRY_CD` varchar(40) COLLATE utf8_bin NOT NULL,
  `POSTAL_STATE_CD` varchar(40) COLLATE utf8_bin NOT NULL,
  `ACTV_IND` varchar(1) COLLATE utf8_bin NOT NULL DEFAULT 'Y',
  PRIMARY KEY (`TRVL_DEST_ID`),
  UNIQUE KEY `TRVL_DEST_TC1` (`OBJ_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `TRVL_DEST_T`
--

LOCK TABLES `TRVL_DEST_T` WRITE;
/*!40000 ALTER TABLE `TRVL_DEST_T` DISABLE KEYS */;
INSERT INTO `TRVL_DEST_T` VALUES ('10000','a9decbd2-5566-11e4-bc0b-0fbd866670fd',1,'Colorado','US','CO','Y');
/*!40000 ALTER TABLE `TRVL_DEST_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `TRVL_CO_T`
--
...
CREATE TABLE `TRVL_CO_T` (
  `CO_ID` varchar(40) COLLATE utf8_bin NOT NULL,
  `CO_NM` varchar(40) COLLATE utf8_bin NOT NULL,
  `OBJ_ID` varchar(36) COLLATE utf8_bin NOT NULL,
  `VER_NBR` decimal(8,0) NOT NULL DEFAULT '1',
  `ACTV_IND` varchar(1) COLLATE utf8_bin NOT NULL DEFAULT 'Y',
  PRIMARY KEY (`CO_ID`),
  UNIQUE KEY `TRVL_CO_TC1` (`OBJ_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `TRVL_CO_T`
--

LOCK TABLES `TRVL_CO_T` WRITE;
/*!40000 ALTER TABLE `TRVL_CO_T` DISABLE KEYS */;
INSERT INTO `TRVL_CO_T` VALUES ('10000','Value Rentals','aafbd7da-5566-11e4-bc0b-0fbd866670fd',1,'Y'),('10001','AAA Travel','ad6bede8-5566-11e4-bc0b-0fbd866670fd',1,'N');
/*!40000 ALTER TABLE `TRVL_CO_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_PARENT_GEN_KEY_T`
--

DROP TABLE IF EXISTS `KRTST_PARENT_GEN_KEY_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_PARENT_GEN_KEY_T` (
  `GENERATED_PK_COL` decimal(8,0) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `KRTST_PARENT_GEN_KEY_T`
--

LOCK TABLES `KRTST_PARENT_GEN_KEY_T` WRITE;
/*!40000 ALTER TABLE `KRTST_PARENT_GEN_KEY_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_PARENT_GEN_KEY_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_CONF_SESS_PRES_T`
--

DROP TABLE IF EXISTS `KRTST_CONF_SESS_PRES_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_CONF_SESS_PRES_T` (
  `ID` varchar(10) COLLATE utf8_bin NOT NULL,
  `SESS_ID` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `PRES_ID` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `PRIMARY_IND` char(1) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `KRTST_CONF_SESS_PRES_FK1` (`SESS_ID`),
  KEY `KRTST_CONF_SESS_PRES_FK2` (`PRES_ID`),
  CONSTRAINT `KRTST_CONF_SESS_PRES_FK2` FOREIGN KEY (`PRES_ID`) REFERENCES `KRTST_CONF_PRESENTER_T` (`ID`),
  CONSTRAINT `KRTST_CONF_SESS_PRES_FK1` FOREIGN KEY (`SESS_ID`) REFERENCES `KRTST_CONF_SESS_T` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `KRTST_CONF_SESS_PRES_T`
--

LOCK TABLES `KRTST_CONF_SESS_PRES_T` WRITE;
/*!40000 ALTER TABLE `KRTST_CONF_SESS_PRES_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_CONF_SESS_PRES_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_CONF_SESS_PRES_S`
--

DROP TABLE IF EXISTS `KRTST_CONF_SESS_PRES_S`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `KRTST_CONF_SESS_PRES_S`
--

LOCK TABLES `KRTST_CONF_SESS_PRES_S` WRITE;
/*!40000 ALTER TABLE `KRTST_CONF_SESS_PRES_S` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_CONF_SESS_PRES_S` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `TRV_ACCT_TYPE` (
  `ACCT_TYPE` varchar(3) COLLATE utf8_bin NOT NULL DEFAULT '',
  `ACCT_TYPE_NAME` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  `OBJ_ID` varchar(36) COLLATE utf8_bin NOT NULL,
  `VER_NBR` decimal(8,0) NOT NULL DEFAULT '1',
...
INSERT INTO `TRV_ACCT_TYPE` VALUES ('CAT','Clearing','CAT',1,'Y'),('EAT','Expense','EAT',1,'Y'),('IAT','Income','IAT',1,'Y');
...
--
-- Table structure for table `TRVL_EXP_ITM_ID_S`
--
...
--
-- Dumping data for table `TRVL_EXP_ITM_ID_S`
--

LOCK TABLES `TRVL_EXP_ITM_ID_S` WRITE;
/*!40000 ALTER TABLE `TRVL_EXP_ITM_ID_S` DISABLE KEYS */;
INSERT INTO `TRVL_EXP_ITM_ID_S` VALUES (10000);
/*!40000 ALTER TABLE `TRVL_EXP_ITM_ID_S` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `TRVL_MLG_RT_ID_S`
--
...
--
-- Dumping data for table `TRVL_MLG_RT_ID_S`
--

LOCK TABLES `TRVL_MLG_RT_ID_S` WRITE;
/*!40000 ALTER TABLE `TRVL_MLG_RT_ID_S` DISABLE KEYS */;
INSERT INTO `TRVL_MLG_RT_ID_S` VALUES (10000);
/*!40000 ALTER TABLE `TRVL_MLG_RT_ID_S` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_TEST_TABLE_T`
--

DROP TABLE IF EXISTS `KRTST_TEST_TABLE_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_TEST_TABLE_T` (
  `PK_PROP` varchar(10) COLLATE utf8_bin NOT NULL DEFAULT '',
  `STR_PROP` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  `LONG_STR_PROP` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `DATE_PROP` datetime DEFAULT NULL,
  `CURR_PROP` decimal(19,2) DEFAULT NULL,
  `NON_STANDARD` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  `BOOL_PROP` char(1) COLLATE utf8_bin DEFAULT 'N',
  `ENCR_PROP` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `RO_PROP` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`PK_PROP`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `KRTST_TEST_TABLE_T`
--

LOCK TABLES `KRTST_TEST_TABLE_T` WRITE;
/*!40000 ALTER TABLE `KRTST_TEST_TABLE_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_TEST_TABLE_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `TRVL_TRAVELER_DTL_ID_S`
--
...
--
-- Dumping data for table `TRVL_TRAVELER_DTL_ID_S`
--

LOCK TABLES `TRVL_TRAVELER_DTL_ID_S` WRITE;
/*!40000 ALTER TABLE `TRVL_TRAVELER_DTL_ID_S` DISABLE KEYS */;
/*!40000 ALTER TABLE `TRVL_TRAVELER_DTL_ID_S` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_PARENT_WITH_MULTI_KEY_T`
--

DROP TABLE IF EXISTS `KRTST_PARENT_WITH_MULTI_KEY_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_PARENT_WITH_MULTI_KEY_T` (
  `FIN_COA_CD` varchar(2) COLLATE utf8_bin NOT NULL DEFAULT '',
  `ACCOUNT_NBR` varchar(7) COLLATE utf8_bin NOT NULL DEFAULT '',
  `ORG_CD` varchar(4) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`FIN_COA_CD`,`ACCOUNT_NBR`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `KRTST_PARENT_WITH_MULTI_KEY_T`
--

LOCK TABLES `KRTST_PARENT_WITH_MULTI_KEY_T` WRITE;
/*!40000 ALTER TABLE `KRTST_PARENT_WITH_MULTI_KEY_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_PARENT_WITH_MULTI_KEY_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_CONF_SESS_T`
--

DROP TABLE IF EXISTS `KRTST_CONF_SESS_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_CONF_SESS_T` (
  `ID` varchar(10) COLLATE utf8_bin NOT NULL,
  `TITLE` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  `SESS_DT` date DEFAULT NULL,
  `START_TIME` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `END_TIME` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `SESS_TYPE_CODE` char(1) COLLATE utf8_bin DEFAULT NULL,
  `DESCRIPTION` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `COORD_ID` bigint(20) DEFAULT NULL,
  `ALT_COORD1_ID` bigint(20) DEFAULT NULL,
  `ALT_COORD2_ID` bigint(20) DEFAULT NULL,
  `ROOM_ID` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `ALT_ROOM1_ID` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `ALT_ROOM2_ID` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `KRTST_CONF_SESS_FK1` (`COORD_ID`),
  KEY `KRTST_CONF_SESS_FK2` (`ALT_COORD1_ID`),
  KEY `KRTST_CONF_SESS_FK3` (`ALT_COORD2_ID`),
  KEY `KRTST_CONF_SESS_FK4` (`ROOM_ID`),
  KEY `KRTST_CONF_SESS_FK5` (`ALT_ROOM1_ID`),
  KEY `KRTST_CONF_SESS_FK6` (`ALT_ROOM2_ID`),
  CONSTRAINT `KRTST_CONF_SESS_FK6` FOREIGN KEY (`ALT_ROOM2_ID`) REFERENCES `KRTST_CONF_ROOM_T` (`ID`),
  CONSTRAINT `KRTST_CONF_SESS_FK1` FOREIGN KEY (`COORD_ID`) REFERENCES `KRTST_CONF_COORD_T` (`ID`),
  CONSTRAINT `KRTST_CONF_SESS_FK2` FOREIGN KEY (`ALT_COORD1_ID`) REFERENCES `KRTST_CONF_COORD_T` (`ID`),
  CONSTRAINT `KRTST_CONF_SESS_FK3` FOREIGN KEY (`ALT_COORD2_ID`) REFERENCES `KRTST_CONF_COORD_T` (`ID`),
  CONSTRAINT `KRTST_CONF_SESS_FK4` FOREIGN KEY (`ROOM_ID`) REFERENCES `KRTST_CONF_ROOM_T` (`ID`),
  CONSTRAINT `KRTST_CONF_SESS_FK5` FOREIGN KEY (`ALT_ROOM1_ID`) REFERENCES `KRTST_CONF_ROOM_T` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `KRTST_CONF_SESS_T`
--

LOCK TABLES `KRTST_CONF_SESS_T` WRITE;
/*!40000 ALTER TABLE `KRTST_CONF_SESS_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_CONF_SESS_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `krns_att_cntnt_t`
--
...
--
-- Dumping data for table `krns_att_cntnt_t`
--

LOCK TABLES `krns_att_cntnt_t` WRITE;
/*!40000 ALTER TABLE `krns_att_cntnt_t` DISABLE KEYS */;
/*!40000 ALTER TABLE `krns_att_cntnt_t` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `krim_entity_addr_t` (
  ...
  `ADDR_LINE_1` varchar(128) COLLATE utf8_bin DEFAULT NULL,
  `ADDR_LINE_2` varchar(128) COLLATE utf8_bin DEFAULT NULL,
  `ADDR_LINE_3` varchar(128) COLLATE utf8_bin DEFAULT NULL,
...
--
-- Table structure for table `KRTST_TYP_PARENT_T`
--

DROP TABLE IF EXISTS `KRTST_TYP_PARENT_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `KRTST_TYP_PARENT_T`
--

LOCK TABLES `KRTST_TYP_PARENT_T` WRITE;
/*!40000 ALTER TABLE `KRTST_TYP_PARENT_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_TYP_PARENT_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `TRVL_TRAVELER_DTL_T`
--
...
CREATE TABLE `TRVL_TRAVELER_DTL_T` (
  ...
  `VER_NBR` decimal(8,0) NOT NULL DEFAULT '1',
  `ACTV_IND` varchar(1) COLLATE utf8_bin DEFAULT 'Y',
  `citizenship` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  `city_nm` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `country_cd` varchar(2) COLLATE utf8_bin DEFAULT NULL,
  `customer_num` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  `doc_nbr` varchar(14) COLLATE utf8_bin DEFAULT NULL,
  `drive_lic_exp_dt` date DEFAULT NULL,
  `drive_lic_num` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `email_addr` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `first_nm` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  `gender` varchar(1) COLLATE utf8_bin DEFAULT NULL,
  `last_nm` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  `MIDDLENAME` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  `non_res_alien` varchar(1) COLLATE utf8_bin DEFAULT NULL,
  `phone_nbr` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `EMP_PRINCIPAL_ID` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `postal_state_cd` varchar(2) COLLATE utf8_bin DEFAULT NULL,
  `addr_line_1` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `addr_line_2` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `traveler_typ_cd` varchar(3) COLLATE utf8_bin DEFAULT NULL,
  `postal_cd` varchar(11) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `TRVL_TRAVELER_DTL_TC0` (`OBJ_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `TRVL_TRAVELER_DTL_T`
--

LOCK TABLES `TRVL_TRAVELER_DTL_T` WRITE;
/*!40000 ALTER TABLE `TRVL_TRAVELER_DTL_T` DISABLE KEYS */;
INSERT INTO `TRVL_TRAVELER_DTL_T` VALUES ('1','IMAGUID',1,'Y','US','Davis','US','CUST','??','2015-06-30','CA12345678',NULL,'Test','M','Traveler','A','N','8005551212','fred','CA','123 Nowhere St.',NULL,'EMP','95616');
/*!40000 ALTER TABLE `TRVL_TRAVELER_DTL_T` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `KRTST_TEST_INDIRECT_COLL_T`
--

DROP TABLE IF EXISTS `KRTST_TEST_INDIRECT_COLL_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_TEST_INDIRECT_COLL_T` (
  `PK_COLL_PROP` varchar(10) COLLATE utf8_bin NOT NULL DEFAULT '',
  `STR_PROP` varchar(40) COLLATE utf8_bin DEFAULT NULL,
...
--
-- Dumping data for table `KRTST_TEST_INDIRECT_COLL_T`
--

LOCK TABLES `KRTST_TEST_INDIRECT_COLL_T` WRITE;
/*!40000 ALTER TABLE `KRTST_TEST_INDIRECT_COLL_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_TEST_INDIRECT_COLL_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_TEST_REF_OBJ_T`
--

DROP TABLE IF EXISTS `KRTST_TEST_REF_OBJ_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_TEST_REF_OBJ_T` (
  `STR_PROP` varchar(10) COLLATE utf8_bin NOT NULL DEFAULT '',
  `OTHER_STR_PROP` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`STR_PROP`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `KRTST_TEST_REF_OBJ_T`
--

LOCK TABLES `KRTST_TEST_REF_OBJ_T` WRITE;
/*!40000 ALTER TABLE `KRTST_TEST_REF_OBJ_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_TEST_REF_OBJ_T` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `KRIM_ROLE_RSP_T` VALUES ('KRSAP10000','b3319228-5566-11e4-bc0b-0fbd866670fd',1,'KRSAP10005','KRSAP10000','Y');
...
--
-- Table structure for table `KRTST_CONF_COORD_S`
--

DROP TABLE IF EXISTS `KRTST_CONF_COORD_S`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `KRTST_CONF_COORD_S`
--

LOCK TABLES `KRTST_CONF_COORD_S` WRITE;
/*!40000 ALTER TABLE `KRTST_CONF_COORD_S` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_CONF_COORD_S` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `KRTST_CONF_COORD_T`
--

DROP TABLE IF EXISTS `KRTST_CONF_COORD_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `KRTST_CONF_COORD_T`
--

LOCK TABLES `KRTST_CONF_COORD_T` WRITE;
/*!40000 ALTER TABLE `KRTST_CONF_COORD_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_CONF_COORD_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_TEST_ANOTHER_REF_OBJ_T`
--

DROP TABLE IF EXISTS `KRTST_TEST_ANOTHER_REF_OBJ_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_TEST_ANOTHER_REF_OBJ_T` (
  `STR_PROP` varchar(10) COLLATE utf8_bin NOT NULL DEFAULT '',
  `DATE_PROP` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `OTHER_STR_PROP` varchar(40) COLLATE utf8_bin DEFAULT NULL,
...
--
-- Dumping data for table `KRTST_TEST_ANOTHER_REF_OBJ_T`
--

LOCK TABLES `KRTST_TEST_ANOTHER_REF_OBJ_T` WRITE;
/*!40000 ALTER TABLE `KRTST_TEST_ANOTHER_REF_OBJ_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_TEST_ANOTHER_REF_OBJ_T` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `KRTST_PARENT_GEN_KEY_CHILD_T`
--

DROP TABLE IF EXISTS `KRTST_PARENT_GEN_KEY_CHILD_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_PARENT_GEN_KEY_CHILD_T` (
  `GENERATED_PK_COL` decimal(8,0) DEFAULT NULL,
  `CHILDS_PK_COL` decimal(8,0) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `KRTST_PARENT_GEN_KEY_CHILD_T`
--

LOCK TABLES `KRTST_PARENT_GEN_KEY_CHILD_T` WRITE;
/*!40000 ALTER TABLE `KRTST_PARENT_GEN_KEY_CHILD_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_PARENT_GEN_KEY_CHILD_T` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `TRVL_AUTH_DOC_T` (
  `TRVL_AUTH_DOC_ID` varchar(40) COLLATE utf8_bin NOT NULL,
  `TRAVELER_DTL_ID` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  `TRVL_TYP_CD` varchar(3) COLLATE utf8_bin DEFAULT NULL,
  `TRVL_BGN_DT` datetime DEFAULT NULL,
  `TRVL_END_DT` datetime DEFAULT NULL,
  `TRVL_DEST_ID` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  `EXP_LMT` decimal(19,2) DEFAULT '0.00',
  `TRVL_DESC` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `CELL_PH_NUM` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `OBJ_ID` varchar(36) COLLATE utf8_bin NOT NULL,
  `VER_NBR` decimal(8,0) NOT NULL DEFAULT '1',
  PRIMARY KEY (`TRVL_AUTH_DOC_ID`),
  UNIQUE KEY `TRVL_AUTH_DOC_TC1` (`OBJ_ID`),
  KEY `TRVL_AUTH_DOC_FK1` (`TRVL_DEST_ID`),
  CONSTRAINT `TRVL_AUTH_DOC_FK1` FOREIGN KEY (`TRVL_DEST_ID`) REFERENCES `TRVL_DEST_T` (`TRVL_DEST_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `TRVL_AUTH_DOC_T` VALUES ('10000','1','IS','2013-12-01 00:00:00','2013-12-04 00:00:00','10000',1000.00,'Kuali Days Conference','1234567','ab8292d4-5566-11e4-bc0b-0fbd866670fd',1);
...
CREATE TABLE `krim_entity_emp_info_t` (
  ...
  KEY `KRIM_ENTITY_EMP_INFO_TI3` (`EMP_ID`),
...
--
-- Table structure for table `TRVL_PD_EXP_T`
--
...
CREATE TABLE `TRVL_PD_EXP_T` (
  `PD_EXP_ID` varchar(40) COLLATE utf8_bin NOT NULL,
  `OBJ_ID` varchar(36) COLLATE utf8_bin NOT NULL,
  `VER_NBR` decimal(8,0) NOT NULL DEFAULT '1',
  `TRVL_DEST_ID` varchar(40) COLLATE utf8_bin NOT NULL,
  `TRVL_AUTH_DOC_ID` varchar(40) COLLATE utf8_bin NOT NULL,
  `PD_DT` datetime DEFAULT NULL,
  ...
  `MLG_RT_ID` varchar(40) COLLATE utf8_bin NOT NULL,
  `MLG_EST` decimal(8,0) NOT NULL,
  PRIMARY KEY (`PD_EXP_ID`),
  UNIQUE KEY `TRVL_PD_EXP_TC1` (`OBJ_ID`),
  KEY `TRVL_PD_EXP_FK1` (`MLG_RT_ID`),
  KEY `TRVL_PD_EXP_FK2` (`TRVL_DEST_ID`),
  KEY `TRVL_PD_EXP_FK3` (`TRVL_AUTH_DOC_ID`),
  CONSTRAINT `TRVL_PD_EXP_FK1` FOREIGN KEY (`MLG_RT_ID`) REFERENCES `TRVL_MLG_RT_T` (`MLG_RT_ID`),
  CONSTRAINT `TRVL_PD_EXP_FK2` FOREIGN KEY (`TRVL_DEST_ID`) REFERENCES `TRVL_DEST_T` (`TRVL_DEST_ID`),
  CONSTRAINT `TRVL_PD_EXP_FK3` FOREIGN KEY (`TRVL_AUTH_DOC_ID`) REFERENCES `TRVL_AUTH_DOC_T` (`TRVL_AUTH_DOC_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `TRVL_PD_EXP_T`
--

LOCK TABLES `TRVL_PD_EXP_T` WRITE;
/*!40000 ALTER TABLE `TRVL_PD_EXP_T` DISABLE KEYS */;
INSERT INTO `TRVL_PD_EXP_T` VALUES ('10000','ac9fa7ec-5566-11e4-bc0b-0fbd866670fd',1,'10000','10000','2014-10-16 15:00:19',10.00,10.00,15.00,20.00,'10000',30);
/*!40000 ALTER TABLE `TRVL_PD_EXP_T` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `TRV_ACCT` (
  ...
  `OBJ_ID` varchar(36) COLLATE utf8_bin NOT NULL,
  `VER_NBR` decimal(8,0) NOT NULL DEFAULT '1',
  `ACCT_NAME` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  `ACCT_TYPE` varchar(3) COLLATE utf8_bin DEFAULT NULL,
  `ACCT_FO_ID` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  `CREATE_DT` datetime DEFAULT NULL,
  `SUBSIDIZED_PCT` decimal(5,2) DEFAULT NULL,
  PRIMARY KEY (`ACCT_NUM`),
  KEY `TRV_ACCT_TR1` (`ACCT_TYPE`),
...
INSERT INTO `TRV_ACCT` VALUES ('a1','a1',1,'Travel Account 1','IAT','fred','2014-06-01 00:00:00',NULL),('a10','a10',1,'Travel Account 10','CAT','eric','2014-06-01 00:00:00',75.00),('a11','a11',1,'Travel Account 11','EAT','erin','2014-06-01 00:00:00',85.00),('a12','a12',1,'Travel Account 12','EAT','eric','2014-06-01 00:00:00',85.00),('a13','a13',1,'Travel Account 13','CAT','fran','2014-06-01 00:00:00',95.00),('a14','a14',1,'Travel Account 14','CAT','fran','2014-06-01 00:00:00',NULL),('a16','a16',1,'Travel Account 16','CAT','fran','2014-06-01 00:00:00',95.00),('a2','a2',1,'Travel Account 2','EAT','fran','2014-06-01 00:00:00',NULL),('a3','a3',1,'Travel Account 3','IAT','frank','2014-06-01 00:00:00',20.00),('a4','a4',1,'Travel Account 4','IAT','erin','2014-06-01 00:00:00',45.00),('a5','a5',1,'Travel Account 5','IAT','eric','2014-06-01 00:00:00',45.00),('a6','a6',1,'Travel Account 6','CAT','fran','2014-06-01 00:00:00',NULL),('a7','a7',1,'Travel Account 7','CAT','erin','2014-06-01 00:00:00',75.00),('a8','a8',1,'Travel Account 8','EAT','fran','2014-06-01 00:00:00',NULL),('a9','a9',1,'Travel Account 9','CAT','fran','2014-06-01 00:00:00',NULL);
/*!40000 ALTER TABLE `TRV_ACCT` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `TRVL_AUTH_DOC_EXT_T`
--

DROP TABLE IF EXISTS `TRVL_AUTH_DOC_EXT_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `TRVL_AUTH_DOC_EXT_T` (
  `DOC_HDR_ID` varchar(14) COLLATE utf8_bin DEFAULT NULL,
  `ANOTHER_PROP` varchar(10) COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `TRVL_AUTH_DOC_EXT_T`
--

LOCK TABLES `TRVL_AUTH_DOC_EXT_T` WRITE;
/*!40000 ALTER TABLE `TRVL_AUTH_DOC_EXT_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `TRVL_AUTH_DOC_EXT_T` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `TRV_ATT_SAMPLE` (
  ...
  `ATT_GRP_NUM` varchar(30) COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `KRTST_UPDATABLE_CHILD_T`
--

DROP TABLE IF EXISTS `KRTST_UPDATABLE_CHILD_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_UPDATABLE_CHILD_T` (
  `PK_COL` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `SOME_DATA_COL` varchar(40) COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `KRTST_UPDATABLE_CHILD_T`
--

LOCK TABLES `KRTST_UPDATABLE_CHILD_T` WRITE;
/*!40000 ALTER TABLE `KRTST_UPDATABLE_CHILD_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_UPDATABLE_CHILD_T` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `TRVL_TRAVELER_TYP_T`
--
...
CREATE TABLE `TRVL_TRAVELER_TYP_T` (
  ...
  `SRC_CODE` varchar(45) COLLATE utf8_bin DEFAULT NULL,
  `NM` varchar(45) COLLATE utf8_bin DEFAULT NULL,
  `ADVANCES_IND` varchar(45) COLLATE utf8_bin DEFAULT NULL,
  `ACTV_IND` varchar(45) COLLATE utf8_bin DEFAULT NULL,
  `OBJ_ID` varchar(45) COLLATE utf8_bin DEFAULT NULL,
  `VER_NBR` decimal(8,0) DEFAULT NULL,
  PRIMARY KEY (`CODE`),
  UNIQUE KEY `TRVL_TRAVELER_TYP_T_TC0` (`OBJ_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `TRVL_TRAVELER_TYP_T`
--

LOCK TABLES `TRVL_TRAVELER_TYP_T` WRITE;
/*!40000 ALTER TABLE `TRVL_TRAVELER_TYP_T` DISABLE KEYS */;
INSERT INTO `TRVL_TRAVELER_TYP_T` VALUES ('EMP',NULL,'Employee',NULL,'Y',NULL,NULL),('NON',NULL,'NON-Employee',NULL,'Y',NULL,NULL);
/*!40000 ALTER TABLE `TRVL_TRAVELER_TYP_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_TEST_TABLE_2_T`
--

DROP TABLE IF EXISTS `KRTST_TEST_TABLE_2_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `KRTST_TEST_TABLE_2_T`
--

LOCK TABLES `KRTST_TEST_TABLE_2_T` WRITE;
/*!40000 ALTER TABLE `KRTST_TEST_TABLE_2_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_TEST_TABLE_2_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_CONF_LBL_T`
--

DROP TABLE IF EXISTS `KRTST_CONF_LBL_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `KRTST_CONF_LBL_T`
--

LOCK TABLES `KRTST_CONF_LBL_T` WRITE;
/*!40000 ALTER TABLE `KRTST_CONF_LBL_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_CONF_LBL_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `TRVL_EXP_ITM_T`
--
...
CREATE TABLE `TRVL_EXP_ITM_T` (
  `EXP_ITM_ID` varchar(40) COLLATE utf8_bin NOT NULL,
  `OBJ_ID` varchar(36) COLLATE utf8_bin NOT NULL,
  `VER_NBR` decimal(8,0) NOT NULL DEFAULT '1',
  `TRVL_AUTH_DOC_ID` varchar(40) COLLATE utf8_bin NOT NULL,
  `TRVL_CO_NM` varchar(40) COLLATE utf8_bin NOT NULL,
  `EXP_TYP_CD` varchar(40) COLLATE utf8_bin NOT NULL,
  `EXP_AMT` decimal(19,2) NOT NULL,
  `EXP_DESC` varchar(255) COLLATE utf8_bin NOT NULL,
  `EXP_DT` datetime DEFAULT NULL,
  `EXP_REIMB` varchar(1) COLLATE utf8_bin DEFAULT 'Y',
  `EXP_TXBL` varchar(1) COLLATE utf8_bin DEFAULT 'Y',
  PRIMARY KEY (`EXP_ITM_ID`),
  UNIQUE KEY `TRVL_EXP_ITM_TC1` (`OBJ_ID`),
  KEY `TRVL_EXP_ITM_FK1` (`TRVL_AUTH_DOC_ID`),
  CONSTRAINT `TRVL_EXP_ITM_FK1` FOREIGN KEY (`TRVL_AUTH_DOC_ID`) REFERENCES `TRVL_AUTH_DOC_T` (`TRVL_AUTH_DOC_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `TRVL_EXP_ITM_T`
--

LOCK TABLES `TRVL_EXP_ITM_T` WRITE;
/*!40000 ALTER TABLE `TRVL_EXP_ITM_T` DISABLE KEYS */;
INSERT INTO `TRVL_EXP_ITM_T` VALUES ('10000','ad5b9f92-5566-11e4-bc0b-0fbd866670fd',1,'10000','Discount Travel','ME',1278.97,'Family Related','2014-10-16 15:00:21','Y','Y');
/*!40000 ALTER TABLE `TRVL_EXP_ITM_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_PARENT_OF_UPDATABLE_T`
--

DROP TABLE IF EXISTS `KRTST_PARENT_OF_UPDATABLE_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_PARENT_OF_UPDATABLE_T` (
  `PK_COL` decimal(8,0) DEFAULT NULL,
  `UPDATABLE_CHILD_KEY_COL` varchar(10) COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `KRTST_PARENT_OF_UPDATABLE_T`
--

LOCK TABLES `KRTST_PARENT_OF_UPDATABLE_T` WRITE;
/*!40000 ALTER TABLE `KRTST_PARENT_OF_UPDATABLE_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_PARENT_OF_UPDATABLE_T` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `KRCR_NMSPC_T` VALUES ('KR-BUS','5B960CFDBB370FDFE0404F8189D83CBD',1,'Service Bus','Y','RICE'),('KR-IDM','61645D045B0005D7E0404F8189D849B1',1,'Identity Management','Y','RICE'),('KR-KRAD','B5BA065471F8326EE0404F8189D87F9A',1,'Kuali Rapid Application Development','Y','RICE'),('KR-LOC','9d1b0d7a-5566-11e4-bc0b-0fbd866670fd',1,'Kuali Location','Y','RICE'),('KR-NS','53680C68F595AD9BE0404F8189D80A6C',1,'Kuali Nervous System','Y','RICE'),('KR-NTFCN','5B960CFDBB360FDFE0404F8189D83CBD',1,'Notification','Y','RICE'),('KR-RULE','AE3195EDFF2300E2E0404F8189D822AE',1,'Kuali Rules','Y','RICE'),('KR-RULE-TEST','5a83c912-94b9-4b4d-ac3f-88c53380a4a3',1,'Kuali Rules Test','Y','RICE'),('KR-SAP','27035960-3755-482e-a2ae-7fac13cc5f45',1,'Sample App','Y','RICE'),('KR-SYS','5B960CFDBB390FDFE0404F8189D83CBD',1,'Enterprise Infrastructure','Y','RICE'),('KR-WKFLW','5E1D690C419B3E2EE0404F8189D82677',0,'Workflow','Y','RICE'),('KUALI','5ADF18B6D4817954E0404F8189D85002',1,'Kuali Systems','Y',NULL);
...
--
-- Table structure for table `TRV_ATT_GRP_SAMPLE`
--
...
CREATE TABLE `TRV_ATT_GRP_SAMPLE` (
  `ATT_GRP_NUM` varchar(10) COLLATE utf8_bin NOT NULL DEFAULT '',
  `OBJ_ID` varchar(36) COLLATE utf8_bin NOT NULL,
  `VER_NBR` decimal(8,0) NOT NULL DEFAULT '1',
  `ATT_GRP_NAME` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`ATT_GRP_NUM`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `TRV_ATT_GRP_SAMPLE`
--

LOCK TABLES `TRV_ATT_GRP_SAMPLE` WRITE;
/*!40000 ALTER TABLE `TRV_ATT_GRP_SAMPLE` DISABLE KEYS */;
/*!40000 ALTER TABLE `TRV_ATT_GRP_SAMPLE` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `KRIM_RSP_T` VALUES ('KRSAP10000','b3306dbc-5566-11e4-bc0b-0fbd866670fd',1,'1','KR-SAP','Review Travel Authorization Document','','Y');
...
--
-- Table structure for table `TRVL_DEST_ID_S`
--
...
--
-- Dumping data for table `TRVL_DEST_ID_S`
--

LOCK TABLES `TRVL_DEST_ID_S` WRITE;
/*!40000 ALTER TABLE `TRVL_DEST_ID_S` DISABLE KEYS */;
INSERT INTO `TRVL_DEST_ID_S` VALUES (10000);
/*!40000 ALTER TABLE `TRVL_DEST_ID_S` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_TEST_YARDO_T`
--

DROP TABLE IF EXISTS `KRTST_TEST_YARDO_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `KRTST_TEST_YARDO_T`
--

LOCK TABLES `KRTST_TEST_YARDO_T` WRITE;
/*!40000 ALTER TABLE `KRTST_TEST_YARDO_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_TEST_YARDO_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `TRVL_PD_EXP_ID_S`
--

LOCK TABLES `TRVL_PD_EXP_ID_S` WRITE;
/*!40000 ALTER TABLE `TRVL_PD_EXP_ID_S` DISABLE KEYS */;
INSERT INTO `TRVL_PD_EXP_ID_S` VALUES (10000);
/*!40000 ALTER TABLE `TRVL_PD_EXP_ID_S` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `TRV_SUB_ACCT`
--
...
CREATE TABLE `TRV_SUB_ACCT` (
  `ACCT_NUM` varchar(10) COLLATE utf8_bin NOT NULL DEFAULT '',
  `SUB_ACCT` varchar(10) COLLATE utf8_bin NOT NULL DEFAULT '',
  `OBJ_ID` varchar(36) COLLATE utf8_bin NOT NULL,
  `VER_NBR` decimal(8,0) NOT NULL DEFAULT '1',
  `SUB_ACCT_NAME` varchar(40) COLLATE utf8_bin DEFAULT NULL,
...
--
-- Dumping data for table `TRV_SUB_ACCT`
--

LOCK TABLES `TRV_SUB_ACCT` WRITE;
/*!40000 ALTER TABLE `TRV_SUB_ACCT` DISABLE KEYS */;
INSERT INTO `TRV_SUB_ACCT` VALUES ('a14','A','a',1,'Sub Account A'),('a14','B','b',1,'Sub Account B'),('a14','C','c',1,'Sub Account C'),('a14','D','d',1,'Sub Account D'),('a14','E','e',1,'Sub Account E'),('a14','F','f',1,'Sub Account F'),('a14','G','g',1,'Sub Account G'),('a14','H','h',1,'Sub Account H'),('a14','I','i',1,'Sub Account Eye'),('a14','J','j',1,'Sub Account J'),('a14','K','k',1,'Sub Account K'),('a14','L','l',1,'Sub Account L'),('a14','M','m',1,'Sub Account M'),('a14','N','n',1,'Sub Account N'),('a14','SUB123','sub123',1,'Sub Account 123'),('a2','SUB1','a2-sub1',1,'Sub Account 1'),('a2','SUB2','a2-sub2',1,'Sub Account 2'),('a3','SUB1','a3-sub1',1,'Sub Account 1'),('a3','SUB2','a3-sub2',1,'Sub Account 2'),('a3','SUB3','a3-sub3',1,'Sub Account 3');
/*!40000 ALTER TABLE `TRV_SUB_ACCT` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `TRVL_CO_ID_S`
--
...
--
-- Dumping data for table `TRVL_CO_ID_S`
--

LOCK TABLES `TRVL_CO_ID_S` WRITE;
/*!40000 ALTER TABLE `TRVL_CO_ID_S` DISABLE KEYS */;
INSERT INTO `TRVL_CO_ID_S` VALUES (10000),(10001);
/*!40000 ALTER TABLE `TRVL_CO_ID_S` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_TWO_KEY_CHILD_T`
--

DROP TABLE IF EXISTS `KRTST_TWO_KEY_CHILD_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_TWO_KEY_CHILD_T` (
  `FIN_COA_CD` varchar(2) COLLATE utf8_bin NOT NULL DEFAULT '',
  `ORG_CD` varchar(4) COLLATE utf8_bin NOT NULL DEFAULT '',
  PRIMARY KEY (`FIN_COA_CD`,`ORG_CD`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `KRTST_TWO_KEY_CHILD_T`
--

LOCK TABLES `KRTST_TWO_KEY_CHILD_T` WRITE;
/*!40000 ALTER TABLE `KRTST_TWO_KEY_CHILD_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_TWO_KEY_CHILD_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_TEST_TABLE_EXT_T`
--

DROP TABLE IF EXISTS `KRTST_TEST_TABLE_EXT_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `KRTST_TEST_TABLE_EXT_T`
--

LOCK TABLES `KRTST_TEST_TABLE_EXT_T` WRITE;
/*!40000 ALTER TABLE `KRTST_TEST_TABLE_EXT_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_TEST_TABLE_EXT_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_TEST_DISABLE_NO_VER_T`
--

DROP TABLE IF EXISTS `KRTST_TEST_DISABLE_NO_VER_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `KRTST_TEST_DISABLE_NO_VER_T`
--

LOCK TABLES `KRTST_TEST_DISABLE_NO_VER_T` WRITE;
/*!40000 ALTER TABLE `KRTST_TEST_DISABLE_NO_VER_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_TEST_DISABLE_NO_VER_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_TEST_COLL_T`
--

DROP TABLE IF EXISTS `KRTST_TEST_COLL_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_TEST_COLL_T` (
  `PK_PROP` varchar(10) COLLATE utf8_bin NOT NULL DEFAULT '',
  `PK_PROP_TWO` varchar(10) COLLATE utf8_bin NOT NULL DEFAULT '',
  `STR_PROP` varchar(40) COLLATE utf8_bin DEFAULT NULL,
...
--
-- Dumping data for table `KRTST_TEST_COLL_T`
--

LOCK TABLES `KRTST_TEST_COLL_T` WRITE;
/*!40000 ALTER TABLE `KRTST_TEST_COLL_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_TEST_COLL_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_COLL_PRNT_T`
--

DROP TABLE IF EXISTS `KRTST_COLL_PRNT_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_COLL_PRNT_T` (
  `PK_PROP` varchar(40) COLLATE utf8_bin NOT NULL,
  `STR_PROP` varchar(20) COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `KRTST_COLL_PRNT_T`
--

LOCK TABLES `KRTST_COLL_PRNT_T` WRITE;
/*!40000 ALTER TABLE `KRTST_COLL_PRNT_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_COLL_PRNT_T` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `KRIM_RSP_ATTR_DATA_T` VALUES ('KRSAP10000','b331c96e-5566-11e4-bc0b-0fbd866670fd',1,'KRSAP10000','7','13','TravelAuthorizationDocument'),('KRSAP10001','b331e6d8-5566-11e4-bc0b-0fbd866670fd',1,'KRSAP10000','7','16','TravelApproval'),('KRSAP10002','b331f8f8-5566-11e4-bc0b-0fbd866670fd',1,'KRSAP10000','7','40','N'),('KRSAP10003','b3320c3a-5566-11e4-bc0b-0fbd866670fd',1,'KRSAP10000','7','41','N');
...
--
-- Table structure for table `TRVL_MLG_RT_T`
--
...
CREATE TABLE `TRVL_MLG_RT_T` (
  `MLG_RT_ID` varchar(40) COLLATE utf8_bin NOT NULL,
  `MLG_RT_CD` varchar(40) COLLATE utf8_bin NOT NULL,
  `OBJ_ID` varchar(36) COLLATE utf8_bin NOT NULL,
  `VER_NBR` decimal(8,0) NOT NULL DEFAULT '1',
  `MLG_RT_NM` varchar(40) COLLATE utf8_bin NOT NULL,
  `MLG_RT` decimal(7,3) NOT NULL,
  `ACTV_IND` varchar(1) COLLATE utf8_bin DEFAULT 'Y',
  PRIMARY KEY (`MLG_RT_ID`),
  UNIQUE KEY `TRVL_MIL_RT_TC1` (`OBJ_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `TRVL_MLG_RT_T`
--

LOCK TABLES `TRVL_MLG_RT_T` WRITE;
/*!40000 ALTER TABLE `TRVL_MLG_RT_T` DISABLE KEYS */;
INSERT INTO `TRVL_MLG_RT_T` VALUES ('10000','DO','aa7a700a-5566-11e4-bc0b-0fbd866670fd',1,'Domestic',0.305,'Y');
/*!40000 ALTER TABLE `TRVL_MLG_RT_T` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `KREW_ATTR_DEFN_T` VALUES ('1','number','KR-SAP','Travel Number','Y','edu.sampleu.travel.bo.TravelAccount',1,NULL),('2','principalId','KR-SAP','Travel Id','Y','org.kuali.rice.kim.api.identity.Person',1,NULL);
...
--
-- Table structure for table `KRTST_TEST_INDIR_LINK_T`
--

DROP TABLE IF EXISTS `KRTST_TEST_INDIR_LINK_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_TEST_INDIR_LINK_T` (
  `PK_PROP` varchar(10) COLLATE utf8_bin NOT NULL DEFAULT '',
  `COLL_PK_PROP` varchar(10) COLLATE utf8_bin NOT NULL DEFAULT '',
  PRIMARY KEY (`PK_PROP`,`COLL_PK_PROP`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `KRTST_TEST_INDIR_LINK_T`
--

LOCK TABLES `KRTST_TEST_INDIR_LINK_T` WRITE;
/*!40000 ALTER TABLE `KRTST_TEST_INDIR_LINK_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_TEST_INDIR_LINK_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_CONF_ROOM_T`
--

DROP TABLE IF EXISTS `KRTST_CONF_ROOM_T`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KRTST_CONF_ROOM_T` (
  `ID` varchar(10) COLLATE utf8_bin NOT NULL,
  `BLDG_NM` varchar(40) COLLATE utf8_bin DEFAULT NULL,
...
--
-- Dumping data for table `KRTST_CONF_ROOM_T`
--

LOCK TABLES `KRTST_CONF_ROOM_T` WRITE;
/*!40000 ALTER TABLE `KRTST_CONF_ROOM_T` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_CONF_ROOM_T` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_CONF_ROOM_S`
--

DROP TABLE IF EXISTS `KRTST_CONF_ROOM_S`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `KRTST_CONF_ROOM_S`
--

LOCK TABLES `KRTST_CONF_ROOM_S` WRITE;
/*!40000 ALTER TABLE `KRTST_CONF_ROOM_S` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_CONF_ROOM_S` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `KRTST_GENERATED_PK_S`
--

DROP TABLE IF EXISTS `KRTST_GENERATED_PK_S`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `KRTST_GENERATED_PK_S`
--

LOCK TABLES `KRTST_GENERATED_PK_S` WRITE;
/*!40000 ALTER TABLE `KRTST_GENERATED_PK_S` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_GENERATED_PK_S` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `KRTST_CONF_SESS_S`
--

DROP TABLE IF EXISTS `KRTST_CONF_SESS_S`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `KRTST_CONF_SESS_S`
--

LOCK TABLES `KRTST_CONF_SESS_S` WRITE;
/*!40000 ALTER TABLE `KRTST_CONF_SESS_S` DISABLE KEYS */;
/*!40000 ALTER TABLE `KRTST_CONF_SESS_S` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `KREW_PPL_FLW_MBR_T` (
  ...
  `ACTN_RQST_PLCY_CD` varchar(1) COLLATE utf8_bin DEFAULT NULL,
  `RSP_ID` varchar(40) COLLATE utf8_bin NOT NULL,
  `FRC_ACTN` decimal(1,0) NOT NULL DEFAULT '1',
...
/*!50013 DEFINER=`RICE_251`@`localhost` SQL SECURITY DEFINER */
...
-- Dump completed on 2014-10-16 15:46:43
