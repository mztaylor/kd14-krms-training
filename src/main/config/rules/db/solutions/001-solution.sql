...
INSERT INTO KRIM_ROLE_T(ROLE_ID, OBJ_ID, VER_NBR, ROLE_NM, NMSPC_CD, DESC_TXT, KIM_TYP_ID, ACTV_IND, LAST_UPDT_DT)
  VALUES ('KRATRN-NCAA-ROLE', uuid(), 1, 'Althetics Dept Approver','KRA-TRNG','Approver for the athletics department','1','Y', now())
;

INSERT INTO KRIM_ROLE_T(ROLE_ID, OBJ_ID, VER_NBR, ROLE_NM, NMSPC_CD, DESC_TXT, KIM_TYP_ID, ACTV_IND, LAST_UPDT_DT)
  VALUES ('KRATRN-INTL-ROLE', uuid(), 1, 'International Office Approver','KRA-TRNG','Approver for the International Office','1','Y', now())
;
...
INSERT INTO KREW_PPL_FLW_T (PPL_FLW_ID, ACTV, NM, NMSPC_CD)
  VALUES ('KRATRN-NCAA-PPF', 'Y', 'Athletic Department Approvers', 'KRA-TRNG')
;

INSERT INTO KREW_PPL_FLW_MBR_T (PPL_FLW_MBR_ID, PPL_FLW_ID, ACTN_RQST_PLCY_CD, MBR_TYP_CD, MBR_ID, PRIO, RSP_ID)
  VALUES ('KRATRN-NCAA-PPF-MBR-1', 'KRATRN-NCAA-PPF', 'F', 'R', 'KRATRN-NCAA-ROLE', 1, 'KRATRN-NCAA-PPF-RSP-1')
;
...
insert into KRMS_CNTXT_VLD_ACTN_TYP_T (CNTXT_VLD_ACTN_ID, CNTXT_ID, ACTN_TYP_ID)
values ('KRATRN-KRMS-2', 'KRATRN-1-CNTXT', '1000')
;

-- NCAA Participation term

insert into KRMS_TERM_SPEC_T (TERM_SPEC_ID, NM, TYP, DESC_TXT, NMSPC_CD, VER_NBR)
  values ('KRATRN-KRMS-NCAA-TERM-SPEC', 'ncaaParticipation', 'java.lang.Boolean', 'NCAA Participation Term Specification', 'KRA-TRNG', 1)
;

insert into KRMS_TERM_T (TERM_ID, TERM_SPEC_ID, DESC_TXT, VER_NBR)
  values ('KRATRN-KRMS-NCAA-TERM', 'KRATRN-KRMS-NCAA-TERM-SPEC', 'NCAA Participation', 1)
;

insert into KRMS_CNTXT_VLD_TERM_SPEC_T (CNTXT_TERM_SPEC_PREREQ_ID, CNTXT_ID, TERM_SPEC_ID, PREREQ)
  values ('KRATRN-KRMS-VLD-NCAA-TERM', 'KRATRN-1-CNTXT', 'KRATRN-KRMS-NCAA-TERM-SPEC', null)
;
...
INSERT INTO KRMS_PROP_T (PROP_ID, DESC_TXT, DSCRM_TYP_CD, RULE_ID, CMPND_SEQ_NO)
  VALUES ('KRATRN-KRMS-NCAA-PROP', 'NCAA Participation', 'S', 'KRATRN-KRMS-NCAA-RULE', 1)
;

INSERT INTO KRMS_PROP_T (PROP_ID, DESC_TXT, DSCRM_TYP_CD, RULE_ID, CMPND_SEQ_NO)
  VALUES ('KRATRN-KRMS-INTL-PROP', 'International Student', 'S', 'KRATRN-KRMS-INTL-RULE', 1)
;

INSERT INTO KRMS_RULE_T (RULE_ID, NM, NMSPC_CD, PROP_ID)
  VALUES ('KRATRN-KRMS-NCAA-RULE', 'NCAA Participation', 'KRA-TRNG', 'KRATRN-KRMS-NCAA-PROP')
;
...
INSERT INTO KRMS_ACTN_T (ACTN_ID, NM, NMSPC_CD, SEQ_NO, TYP_ID, RULE_ID)
  VALUES ('KRATRN-KRMS-NCAA-ACTN', 'Notify Athletics Dept Approvers', 'KRA-TRNG', 1, '1000', 'KRATRN-KRMS-NCAA-RULE')
;
...
INSERT INTO KRMS_ACTN_ATTR_T (ACTN_ATTR_DATA_ID, ATTR_VAL, ACTN_ID, ATTR_DEFN_ID)
  VALUES ('KRATRN-KRMS-NCAA-ACTN-ATTR-1', 'Athletics Department Approvers', 'KRATRN-KRMS-NCAA-ACTN', '1006')
;

INSERT INTO KRMS_ACTN_ATTR_T (ACTN_ATTR_DATA_ID, ATTR_VAL, ACTN_ID, ATTR_DEFN_ID)
  VALUES ('KRATRN-KRMS-NCAA-ACTN-ATTR-2', 'KRATRN-NCAA-PPF', 'KRATRN-KRMS-NCAA-ACTN', '1000')
;
...
INSERT INTO KRMS_AGENDA_ITM_T (AGENDA_ITM_ID, AGENDA_ID, RULE_ID, ALWAYS)
  VALUES ('KRATRN-KRMS-NCAA-AGENDA-ITEM', 'KRATRN-KRMS-APPL-AGENDA', 'KRATRN-KRMS-NCAA-RULE', 'KRATRN-KRMS-INTL-AGENDA-ITEM')
;

UPDATE KRMS_AGENDA_T SET INIT_AGENDA_ITM_ID = 'KRATRN-KRMS-NCAA-AGENDA-ITEM'
...
INSERT INTO KRMS_PROP_PARM_T (PROP_PARM_ID, PARM_TYP_CD, SEQ_NO, PARM_VAL, PROP_ID)
  VALUES ('KRATRN-KRMS-NCAA-PROP-PARM-1', 'T', 1, 'KRATRN-KRMS-NCAA-TERM', 'KRATRN-KRMS-NCAA-PROP')
;

INSERT INTO KRMS_PROP_PARM_T (PROP_PARM_ID, PARM_TYP_CD, SEQ_NO, PARM_VAL, PROP_ID)
  VALUES ('KRATRN-KRMS-NCAA-PROP-PARM-2', 'C', 2, 'true', 'KRATRN-KRMS-NCAA-PROP')
;

INSERT INTO KRMS_PROP_PARM_T (PROP_PARM_ID, PARM_TYP_CD, SEQ_NO, PARM_VAL, PROP_ID)
  VALUES ('KRATRN-KRMS-NCAA-PROP-PARM-3', 'O', 3, '=', 'KRATRN-KRMS-NCAA-PROP')
;

INSERT INTO KRMS_PROP_PARM_T (PROP_PARM_ID, PARM_TYP_CD, SEQ_NO, PARM_VAL, PROP_ID)
  VALUES ('KRATRN-KRMS-INTL-PROP-PARM-1', 'T', 1, 'KRATRN-KRMS-CTRY-TERM', 'KRATRN-KRMS-INTL-PROP')
;

INSERT INTO KRMS_PROP_PARM_T (PROP_PARM_ID, PARM_TYP_CD, SEQ_NO, PARM_VAL, PROP_ID)
  VALUES ('KRATRN-KRMS-INTL-PROP-PARM-2', 'C', 2, 'USA', 'KRATRN-KRMS-INTL-PROP')
;

INSERT INTO KRMS_PROP_PARM_T (PROP_PARM_ID, PARM_TYP_CD, SEQ_NO, PARM_VAL, PROP_ID)
  VALUES ('KRATRN-KRMS-INTL-PROP-PARM-3', 'O', 3, '!=', 'KRATRN-KRMS-INTL-PROP')
;
