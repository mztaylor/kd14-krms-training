 ...
 *
 */
public class TestScoreTermResolver<T> implements TermResolver<T> {
	
	private T result;
	private String outputName;
	private Set<String> params;
	
	public TestScoreTermResolver(String outputName, T result) {
		this(outputName, null, result);
	}
	
	public TestScoreTermResolver(String outputName, String [] params, T result) {
